...
public class HzjxwDocument {
    ...
    public HzjxwDocument(Integer id, String title, String url, Date date, String urlAttachment, Date createTime, Date updateTime, String content) {
        this.id = id;
        this.title = title;
        this.url = url;
        this.date = date;
